export interface EventMap {
  ...
  'notice': { level: 'info' | 'warn'; code: string; message: string; agentId?: string; chatId?: string; droppedToolMessages?: number; droppedToolCalls?: number; serverName?: string; error?: string };
}
